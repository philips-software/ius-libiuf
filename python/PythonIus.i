...
%extend IusParameterDict{
        ...
        ~IusParameterDict() {
            iusParameterDictDelete($self);
        }

        int __len__()
        {
            return iusParameterDictGetSize($self);
        }

        void __setitem__(char *key, char *value)
        {
            iusParameterDictSet($self, key, value);
        }

        char *__getitem__(char *key)
        {
            return iusParameterDictGet($self, key);
        }
