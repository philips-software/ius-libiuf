...
demodulation = iufDemodulationCreateWithoutTGCandFilter( ...
    IUF_DEMODULATION_QUADRATURE, ...
    iufIqStruct.ReceiveSettings.sampleFrequency, ...
    iufIqStruct.DrivingScheme.numSamplesPerLine / 2 ); % I and Q samples!
    %iufIqStruct.ReceiveSettings.TimeGainControl.numValues, ...
    %filterKernelSize);
