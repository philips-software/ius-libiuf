...
TEST(Ius2DTransducerElementList, testIus2DTransducerElementListSerialization)
{
    ...
    status = ius2DTransducerElementListSave(_2dTransducerElementList, p2DTransducerElementListPath, handle);
    TEST_ASSERT_EQUAL(IUS_ERR_VALUE, status);
    ...
    iu2dtel_t saved2DTransducerElementList = ius2DTransducerElementListLoad(handle, p2DTransducerElementListPath);
