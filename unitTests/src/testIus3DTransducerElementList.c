...
TEST(Ius3DTransducerElementList, testIus3DTransducerElementListSerialization)
{
    ...
    status = iusHL3DTransducerElementListSave(_3dTransducerElementList, p3DTransducerElementListPath, handle);
    TEST_ASSERT_EQUAL(IUS_ERR_VALUE, status);
    ...
    iu3dtel_t saved3DTransducerElementList = iusHL3DTransducerElementListLoad(handle, p3DTransducerElementListPath);
